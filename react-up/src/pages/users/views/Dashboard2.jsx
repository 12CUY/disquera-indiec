    ...
    <div className="flex-1 ml-10 md:ml-72 cursor-pointer  bg-black min-h-screen">
      ...
      <main className="flex-1 p-6 overflow-y-auto bg-black">
        ...
        <section className="mt-6 ml-12">
          <h2 className="text-xl font-semibold text-white mb-4">Tus listas de reproducción</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            ...
            <div className="group bg-gray-800 p-6 rounded-lg h-48 relative overflow-hidden">
              <img src="/img/imagen2.jpg" alt="Portada 1" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
              {/* Icono de Play */}
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.25 5.75l13.5 6.25-13.5 6.25V5.75z"></path>
                </svg>
              </div>
            </div>
            <div className="group bg-gray-800 p-6 rounded-lg h-48 relative overflow-hidden">
            ...
            <div className="group bg-gray-800 p-6 rounded-lg h-48 relative overflow-hidden">
              <img src="/img/imagen2.jpg" alt="Portada 2" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
              {/* Icono de Play */}
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.25 5.75l13.5 6.25-13.5 6.25V5.75z"></path>
            ...
            <div className="group bg-gray-800 p-6 rounded-lg h-48 relative overflow-hidden">
              <img src="/img/imagen2.jpg" alt="Portada 3" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
              {/* Icono de Play */}
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.25 5.75l13.5 6.25-13.5 6.25V5.75z"></path>
            ...
            <div className="group bg-gray-800 p-6 rounded-lg h-48 relative overflow-hidden">
              <img src="/img/imagen2.jpg" alt="Portada 4" className="absolute inset-0 w-full h-full object-cover rounded-lg" />
              {/* Icono de Play */}
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.25 5.75l13.5 6.25-13.5 6.25V5.75z"></path>
