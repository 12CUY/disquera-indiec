...
const Compras = () => {
  const [compras, setCompras] = useState([
    { id: 1, nombre: "Cancion 1", artista: "Artista A", precio: "$2.99", fecha: "2024-01-31", imagen: "/img/imagen1.jpg" },
    { id: 2, nombre: "Cancion 2", artista: "Artista B", precio: "$3.49", fecha: "2024-01-30", imagen: "/img/imagen1.jpg" },
    { id: 3, nombre: "Cancion 3", artista: "Artista C", precio: "$1.99", fecha: "2024-01-28", imagen: "/img/imagen1.jpg" },
    { id: 4, nombre: "Cancion 4", artista: "Artista D", precio: "$4.99", fecha: "2024-01-15", imagen: "/img/imagen1.jpg" },
    { id: 5, nombre: "Cancion 5", artista: "Artista E", precio: "$2.00", fecha: "2024-01-20", imagen: "/img/imagen1.jpg" },
    { id: 6, nombre: "Cancion 6", artista: "Artista F", precio: "$1.00", fecha: "2024-01-24", imagen: "/img/imagen1.jpg" },
  ]);
    ...
    <div className="flex-1 ml-10 md:ml-72 cursor-pointer">
      ...
      <div className="flex flex-col justify-start items-center min-h-screen px-4 pt-4 bg-black">
        ...
        <div className="w-full bg-cover bg-center rounded-2xl shadow-lg p-6 bg-black mt-8">
          <h2 className="text-white text-lg font-semibold mb-4">Historial de Compras</h2>
          <table className="w-full text-white border-collapse">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="py-2 text-left">Imagen</th> {/* Nueva columna de Imagen */}
              ...
              {compras.map((compra) => (
                <tr key={compra.id} className="border-b border-gray-700">
                  <td className="py-2">
                    ...
                    <img src={compra.imagen} alt={compra.nombre} className="w-16 h-16 object-cover rounded" />
                  </td>
